...
export default function NavEdu() {
  return (
    <div className='p-7'>
       <div>
        <p className='text-5xl font-extrabold text-green-400 text-center m-5'>
        🎓 Education:
        </p>
       </div>
        <div className='flex justify-start'>
            <div className='box bg-amber-200 text-black font-bold shadow-lg shadow-amber-300/50 h-auto w-200 p-5 m-4 flex flex-col gap-4'> 
        ...
        <div className='flex justify-end'>
            <div className='box bg-green-200 text-black font-bold shadow-lg shadow-green-300/50 h-auto w-200 p-5 m-4 flex flex-col gap-4'>
        ...
        <div className='flex justify-start'>
            <div className='box bg-blue-200 text-black font-bold shadow-lg shadow-blue-300/50 h-auto w-200 p-5 m-4 flex flex-col gap-4'>
