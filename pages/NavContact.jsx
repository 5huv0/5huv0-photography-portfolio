...
export default function Contacts() {
  return (
    <div className='flex flex-col items-center justify-center h-screen'>
      ...
      <div className='bg-[#FEE715] w-9/12 h-80 p-20 flex justify-center'> {/* This is text head part*/}
        <p className='font-extrabold text-7xl flex font-serif text-[#101820]'>
          Connect with me Here
        </p>
      </div>

      <div className='bg-[#FEE715] w-9/12 p-10 flex justify-center gap-5 '> {/* This is linkings part*/}
        <button className='hover:bg-red-600 rounded-full w-16 h-8 justify-center flex transition ease-in-out delay-100'>
            <Link
